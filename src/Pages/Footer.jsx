...
const Footer = () => {
  return (
    <footer
      className="grid grid-cols-2 md:grid-cols-[180px_1fr_180px]
     border-black border-2 bg-white md:mt-50"
    >
      ...
      <button
        className="md:col-start-3 border-black md:border-l-2 
      ...
      >
        &copy; 2022 Stiwar Mosquera • Realizado con ReactJs • Almacenado en
        GitHub
      </div>
    </footer>
